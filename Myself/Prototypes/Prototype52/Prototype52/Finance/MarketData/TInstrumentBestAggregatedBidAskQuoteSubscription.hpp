...
namespace MarketData
{
   ...
   template
      ...
      >
   class TInstrumentBestAggregatedBidAskQuoteSubscription sealed :
      public TInstrumentBestAggregatedBidAskQuoteSubscriptionBase< TInstrumentBestAggregatedBidAskQuoteSubscription< TInstrument_ >, TInstrument_ >
   {
